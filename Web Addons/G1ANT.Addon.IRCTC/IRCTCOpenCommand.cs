...
{
    [Command(Name = "irctc.open", Tooltip = "This navigates to the IRCTC webpage into specified web browser")]
    public class IRCTCOpenCommand : Language.Command
    {
        public class Arguments : SeleniumCommandArguments
        {
            ...
            public TextStructure Url { get; set; } = new TextStructure("www.irctc.co.in");
        ...
        public IRCTCOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
