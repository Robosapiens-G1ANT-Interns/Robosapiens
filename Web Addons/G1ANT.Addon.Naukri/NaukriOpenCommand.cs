...
{
    [Command(Name = "naukri.open", Tooltip = "This command opens naukri webpage")]
    public class NaukriOpenCommand : Language.Command
    {
        public class Arguments : SeleniumCommandArguments
        {
            ...
            public TextStructure Url { get; set; } = new TextStructure("www.naukri.com");
        ...
        public NaukriOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
