...
{
    [Command(Name = "swiggy.login", Tooltip = "This will log into your swiggy account")]
    public class SwiggyLoginCommand : Language.Command
    {
        public class Arguments : SeleniumCommandArguments
        {
            // Enter all arguments you need
            [Argument(Name = "Login", Required = false, Tooltip = "Enter your phone no as login id here")]
        ...
        public SwiggyLoginCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
        ...
        public void Execute(Arguments arguments)
        {
            ...
            arguments.Search.Value = "/html/body/div[1]/div[1]/header/div/div/ul/li[2]/div/span[2]";
            arguments.By.Value = "xpath";
            SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value, arguments.WaitForNewWindow.Value);
                                     
            arguments.Search.Value = "/html/body/div[4]/div/div/div[2]/div/div/div/form/div[1]/div/input";
            arguments.By.Value = "xpath";
            ...
            arguments.Search.Value = "/html/body/div[4]/div/div/div[2]/div/div/div/form/div[2]/a";
            arguments.By.Value = "xpath";
            SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value, arguments.WaitForNewWindow.Value);
