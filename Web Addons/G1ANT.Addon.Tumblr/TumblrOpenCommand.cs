...
{
    [Command(Name = "tumblr.open", Tooltip = "This will open a tumbler webpage in a specified browser")]
    public class TumblrOpenCommand : Language.Command
    {
        public class Arguments : SeleniumCommandArguments
        {
            ...
            [Argument(DefaultVariable = "Tumbler webpage", Tooltip = "URL address of a webpage to be loaded")]
            public TextStructure Url { get; set; } = new TextStructure("https://www.tumblr.com/");
        ...
        public TumblrOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
