...
using G1ANT.Addon.Zomato.Properties;
using System.IO;

namespace G1ANT.Addon.Zomato
{
    [Addon(Name = "Zomato", Tooltip = "Zomato Commands")]
    [Copyright(Author = "G1ANT LTD", Copyright = "G1ANT LTD", Email = "hi@g1ant.com", Website = "www.g1ant.com")]
    [License(Type = "LGPL", ResourceName = "License.txt")]
    [CommandGroup(Name = "zomato", Tooltip = "Commands to work with web pages via supported web browsers.", IconName = "seleniumicon")]
    public class ZomatoAddon : Language.Addon
    {
