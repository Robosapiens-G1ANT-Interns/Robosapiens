...
using G1ANT.Addon.Quora.Properties;
using System.IO;

namespace G1ANT.Addon.Quora
{
    [Addon(Name = "Quora", Tooltip = "Quora Commands")]
    [Copyright(Author = "G1ANT LTD", Copyright = "G1ANT LTD", Email = "hi@g1ant.com", Website = "www.quora.com")]
    [License(Type = "LGPL", ResourceName = "License.txt")]
    [CommandGroup(Name = "quora", Tooltip = "Commands to work with web pages via supported web browsers.", IconName = "seleniumicon")]
    public class QuoraAddon : Language.Addon
    {
