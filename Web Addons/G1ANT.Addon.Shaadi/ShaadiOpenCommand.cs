...
{
    [Command(Name = "shaadi.open", Tooltip = "This command opens shaadi account")]
    public class ShaadiOpenCommand : Language.Command
    {
        public class Arguments : SeleniumCommandArguments
        {
            ...
            public TextStructure Url { get; set; } = new TextStructure("www.shaadi.com");
        ...
        public ShaadiOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
