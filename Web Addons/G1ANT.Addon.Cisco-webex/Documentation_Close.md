...
```G1ANT
webex.close type ⟦text⟧ url ⟦text⟧ nowait ⟦bool⟧
```
...
#Note: the commands require opening a browser with the webex.open command first.

## Example

This script open webex and close;
