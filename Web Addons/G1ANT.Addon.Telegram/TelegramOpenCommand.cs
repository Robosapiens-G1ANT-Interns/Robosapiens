...
{
    [Command(Name = "telegram.open", Tooltip = "This command opens telegram ")]
    public class TelegramOpenCommand : Language.Command
    {
        public class Arguments : SeleniumCommandArguments
        {
            ...
            public TextStructure Url { get; set; } = new TextStructure("www.telegram.com");
        ...
        public TelegramOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
