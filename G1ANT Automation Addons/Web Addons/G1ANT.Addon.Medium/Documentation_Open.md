...
```G1ANT
medium.open type ⟦text⟧ url ⟦text⟧ nowait ⟦bool⟧
```

## Description


This command genrates url and goes to medium server
...
This simple script opens chrome browser and runs a Google search for “medium”:
