...
```G1ANT
medium.close type ⟦text⟧ url ⟦text⟧ nowait ⟦bool⟧
```
...
#Note: the commands require opening a browser with the medium.open command first.

## Example

This script open medium and close;
