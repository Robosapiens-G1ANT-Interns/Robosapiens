...
{
    [Command(Name = "chingari.open", Tooltip = "This script is used to open chingari ")]
    public class chingariopenCommand : Command
    {
        public chingariopenCommand(AbstractScripter scripter) : base(scripter)
        {
