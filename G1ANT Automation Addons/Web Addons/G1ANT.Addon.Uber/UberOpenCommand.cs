...
{
    [Command(Name = "uber.open", Tooltip = "This will navigate to the Uber's webpage")]
    public class UberOpenCommand : Language.Command
    {
        ...
        public UberOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
