...
{
    [Command(Name = "rapido.open", Tooltip = "This script is used to open new page")]
    class RapidoOpenCommand : Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure Url { get; set; } = new TextStructure("www.rapido.bike");
