...
```G1ANT
rapido.close type ⟦text⟧ url ⟦text⟧ nowait ⟦bool⟧
```
...
#Note: the commands require opening a browser with the rapido.open command first.

## Example

This script open line and close;
