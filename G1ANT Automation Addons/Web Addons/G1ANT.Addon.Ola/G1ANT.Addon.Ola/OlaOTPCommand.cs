...
{
    [Command(Name = "ola.otp", Tooltip = "This will enter otp for your ola account")]
    public class OlaOTPCommand : Language.Command
    {
        public class Arguments : SeleniumCommandArguments
        {
            // Enter all arguments you need
            [Argument(Name = "OTP Received", Required = true, Tooltip = "Enter otp received on your mob number")]
        ...
        public OlaOTPCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
