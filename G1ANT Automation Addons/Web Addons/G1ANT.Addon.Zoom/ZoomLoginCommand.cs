...
{
    [Command(Name = "zoom.login", Tooltip = "This command log in zoom account")]
    public class ZoomLoginCommand : Language.Command
    {
        ...
        public ZoomLoginCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
        ...
        {
            arguments.Search.Value = "/html/body/div[1]/div[2]/div[1]/div[1]/div[2]/div[2]/div/ul[2]/li[5]/a";
            ...
            arguments.Search.Value = "/html/body/div[1]/div[3]/div[2]/div[2]/div/div[2]/div/form/div[4]/div/div[1]/a";
            arguments.By.Value = "xpath";
            SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value, waitForNewWindow: true);
        }
    }
