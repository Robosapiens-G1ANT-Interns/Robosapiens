...
{
    [Command(Name = "zoom.open", Tooltip = "This command opens zoom")]
    public class ZoomOpenCommand : Language.Command
    {
        public class Arguments : SeleniumCommandArguments
        {
            ...
            public TextStructure Url { get; set; } = new TextStructure("www.zoom.com");
        ...
        public ZoomOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
