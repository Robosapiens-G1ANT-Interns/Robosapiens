...
{
    [Command(Name = "instagram.open", Tooltip = "Opens Instagram")]
    public class InstagramOpenCommand : Language.Command
    {
        ...
        public InstagramOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
