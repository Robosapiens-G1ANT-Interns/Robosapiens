...
namespace G1ANT.Addon.Instagram.Variables
{
    [Variable(
        Name = "timeoutselenium",
        Tooltip = "Determines the timeout value (in ms) for several `Instagram.` commands; the default value is 30000 (30 seconds)")]
