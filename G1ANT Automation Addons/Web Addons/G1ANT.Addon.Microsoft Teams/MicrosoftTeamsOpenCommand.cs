...
using G1ANT.Addon.MicrosoftTeams;
using OpenQA.Selenium;

namespace G1ANT.Addon.MicrosoftTeams
{
    [Command(Name = "microsoftteams.open", Tooltip = "This command open microsoft teams")]
    public class MicrosoftTeamsOpenCommand : Language.Command
    {
        public class Arguments : SeleniumCommandArguments
        {
            ...
            public TextStructure Url { get; set; } = new TextStructure("www.MicrosoftTeams.com");
        ...
        public MicrosoftTeamsOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
        ...
        public void Execute(Arguments arguments)
        {
            ...
            SeleniumManager.CurrentWrapper.Navigate("https://www.microsoft.com/en-in/microsoft-365/microsoft-teams/group-chat-software", arguments.Timeout.Value, arguments.NoWait.Value);
        }
    }
}