...
```G1ANT
linkedin.open type ⟦text⟧ url ⟦text⟧ nowait ⟦bool⟧
```
...
This script opens chrome browser and runs a Google search for “Linkedin”:

```G1ANT
linkedin.open chrome url https://www.linkedin.com/
```
