...
```G1ANT
linkedin.post type ⟦text⟧ url ⟦text⟧ nowait ⟦bool⟧
```
...
| `post`          | [text] |yes           |         |Enter the post you want to update|
...
This simple script opens chrome browser and open your linked in and post the specifed thing

```G1ANT
linkedin.open browse chrome
linkedin.login loginid <Enter your loginid here> password <Enter your password here>
delay 10
linkedin.post  <update here>
```
