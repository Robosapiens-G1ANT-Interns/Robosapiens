...
{
    [Command(Name = "swiggy.open", Tooltip = "This will open Swiggy webpage in chosen web browser")]
    public class SwiggyOpenCommand : Language.Command
    {
        public class Arguments : SeleniumCommandArguments
        {
            ...
            [Argument(DefaultVariable = "Swiggy webpage", Tooltip = "URL address of a webpage to be loaded")]
            public TextStructure Url { get; set; } = new TextStructure("https://www.swiggy.com");
        ...
        public SwiggyOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
