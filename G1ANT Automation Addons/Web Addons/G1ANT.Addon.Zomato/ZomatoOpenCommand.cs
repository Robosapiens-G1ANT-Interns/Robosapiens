...
{
    [Command(Name = "zomato.open", Tooltip = "This will navigate to zomato's webpage into specified web browser")]
    public class ZomatoOpenCommand : Language.Command
    {
        public class Arguments : SeleniumCommandArguments
        {
            ...
            public TextStructure Url { get; set; } = new TextStructure("www.zomato.com");
        ...
        public ZomatoOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
