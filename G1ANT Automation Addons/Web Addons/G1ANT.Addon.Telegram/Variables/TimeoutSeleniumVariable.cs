...
namespace G1ANT.Addon.Telegram.Variables
{
    [Variable(
        Name = "timeoutselenium",
        Tooltip = "Determines the timeout value (in ms) for several `Telegram.` commands; the default value is 30000 (30 seconds)")]
