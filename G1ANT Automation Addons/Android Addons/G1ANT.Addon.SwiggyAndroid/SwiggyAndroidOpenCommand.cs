...
{
    [Command(Name = "swiggyandroid.open", Tooltip = "This command initialises appium server and open Swiggy App.")]
    public class SwiggyAndroidOpenCommand : Language.Command
    {
        ...
        public class Arguments : AppiumCommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("in.swiggy.android.activities.HomeActivity");
        ...
        public SwiggyAndroidOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
