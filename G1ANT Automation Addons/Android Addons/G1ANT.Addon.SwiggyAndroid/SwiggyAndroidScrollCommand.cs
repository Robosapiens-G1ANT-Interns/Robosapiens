...
{
    [Command(Name = "swiggyandroid.scroll", Tooltip = "This command is used to perform scroll action")]
    public class SwiggyAndroidScrollCommand : Language.Command
    {
        ...
        public SwiggyAndroidScrollCommand(AbstractScripter scripter) : base(scripter)
        {
