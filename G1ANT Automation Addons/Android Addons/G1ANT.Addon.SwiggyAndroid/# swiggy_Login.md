...
| -------- | ---- | -------- | ------------- | ----------- |
| `phone` | [text] |yes  |    |Enter phone number registered to your swiggy account |
...
This simple script opens chrome, searches for swiggy's webpage and login into your account by credentials that have been provided by you.

```G1ANT
swiggy.open browse chrome
swiggy.login phone <Enter your phone here> 
```
