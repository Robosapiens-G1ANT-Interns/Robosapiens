...
{
    [Command(Name = "irctcandroid.scroll", Tooltip = "This command is used to perform scroll action")]
    public class IRCTCAndroidScrollCommand : Language.Command
    {
        ...
        public IRCTCAndroidScrollCommand(AbstractScripter scripter) : base(scripter)
        {
