...
{
    [Command(Name = "irctcandroid.open", Tooltip = "This command initialises appium server and opens IRCTC app.")]
    public class IRCTCAndroidOpenCommand : Language.Command
    {
        ...
        public IRCTCAndroidOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
