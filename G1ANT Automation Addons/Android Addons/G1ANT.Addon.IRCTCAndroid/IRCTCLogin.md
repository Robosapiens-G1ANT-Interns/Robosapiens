...
```G1ANT
irctc.login userid ⟦text⟧ password ⟦text⟧
```
...
This simple script opens chrome, searches for irctc's webpage and login into your account by credentials that have been provided by you.
