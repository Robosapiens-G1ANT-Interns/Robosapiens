...
```G1ANT
quora.login loginid ⟦text⟧ password ⟦text⟧
```
...
This simple script opens chrome, searches for Quora's webpage and login into your account by credentials that have been provided by you.
