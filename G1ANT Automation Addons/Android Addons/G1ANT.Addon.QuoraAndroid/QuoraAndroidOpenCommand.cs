...
{
    [Command(Name = "quoraandroid.open", Tooltip = "This command initialises appium server and opens Quora app.")]
    public class QuoraAndroidOpenCommand : Language.Command
    {
        private static AndroidDriver<AndroidElement> driver;

        public class Arguments : AppiumCommandArguments
        {
            [Argument(DefaultVariable = "AppActivity", Required = false, Tooltip = "AppActivity")]
            public TextStructure AppActivity { get; set; } = new TextStructure("com.quora.android.components.activities.QuoraActivity");

            [Argument(DefaultVariable = "AppPackage", Required = false, Tooltip = "App Package")]
        ...
        public QuoraAndroidOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
