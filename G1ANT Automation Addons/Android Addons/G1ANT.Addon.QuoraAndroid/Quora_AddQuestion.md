...
```G1ANT
quora.addquestion question ⟦text⟧ 
```
...
| `question` | [text] |yes   |    |Enter question you want to ask on your quora account |
...
delay 2
quora.addquestion question <Enter your question to be asked,here>
```
