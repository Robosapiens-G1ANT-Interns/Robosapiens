...
{
    [Command(Name = "quoraandroid.scroll", Tooltip = "This command is used to perform scroll action")]
    public class QuoraAndroidScrollCommand : Language.Command
    {
        ...
        public QuoraAndroidScrollCommand(AbstractScripter scripter) : base(scripter)
        {
