...
{
    [Command(Name = "quoraandroid.notifications", Tooltip = "Click on 'Notifications' tab option")]
    public class QuoraAndroidNotificationsCommand : Language.Command
    {
        ...
        public QuoraAndroidNotificationsCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
