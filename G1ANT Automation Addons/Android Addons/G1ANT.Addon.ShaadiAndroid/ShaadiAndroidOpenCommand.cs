...
{
    [Command(Name = "shaadiandroid.open", Tooltip = "Opens shaadi app instance on a connected android device.")]
    public class OpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("ui.main.MainActivity");
