...
{
    [Command(Name = "microsoftteamsandroid.open", Tooltip = "Opens microsoftteams app instance on a connected android device.")]
    public class MicrosoftTeamsAndroidOpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("com.microsoft.skype.teams.views.activities.MainActivity");
        ...
        public MicrosoftTeamsAndroidOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
