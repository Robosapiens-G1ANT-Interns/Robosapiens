...
| `tab` | [text] |yes   |    |Enter tab you want to navigate on your zomato account |
...
This simple script opens chrome, searches for zomato's webpage and login into your account by credentials that have been provided by you. Then wait for 2 seconds and adds question you want to add to your zomato account.

```G1ANT
zomato.open browse chrome
zomato.login loginid <Enter your loginid here> password <Enter your password here>
delay 2
zomato.tab tab <Enter tab you want to navigate,here>
```