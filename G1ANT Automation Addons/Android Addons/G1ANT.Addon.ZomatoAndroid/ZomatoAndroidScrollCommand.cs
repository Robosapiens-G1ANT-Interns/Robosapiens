...
{
    [Command(Name = "zomatoandroid.scroll", Tooltip = "This command is used to perform scroll action")]
    public class ZomatoAndroidScrollCommand : Language.Command
    {
        ...
        public ZomatoAndroidScrollCommand(AbstractScripter scripter) : base(scripter)
        {
