...
{
    [Command(Name = "zomatoandroid.open", Tooltip = "This command initialises appium server and opens Zomato app.")]
    public class ZomatoAndroidOpenCommand : Language.Command
    {
        ...
        public class Arguments : AppiumCommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("com.application.zomato.tabbed.home.HomeActivity");
        ...
        public ZomatoAndroidOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
