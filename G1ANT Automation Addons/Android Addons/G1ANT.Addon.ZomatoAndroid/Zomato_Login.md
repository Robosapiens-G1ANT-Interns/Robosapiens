...
```G1ANT
zomato.login loginid ⟦text⟧ password ⟦text⟧
```
...
This simple script opens chrome, searches for zomato's webpage and login into your account by credentials that have been provided by you.
