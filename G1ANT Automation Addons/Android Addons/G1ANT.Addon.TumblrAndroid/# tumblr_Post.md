...
| `post` | [text] |yes   |    |Enter post you want to add on your tumblr account |
...
This simple script opens chrome, searches for tumblr's webpage and login into your account by credentials that have been provided by you. Then wait for 2 seconds and adds post you want to add to your tumblr account.

```G1ANT
tumblr.open browse chrome
tumblr.login loginid <Enter your loginid here> password <Enter your password here>
delay 2
tumblr.post post<Enter your question to be asked,here>
```
