...
| `tab` | [text] |yes   |    |Enter tab you want to navigate on your tumblr account |
...
This simple script opens chrome, searches for tumblr's webpage and login into your account by credentials that have been provided by you. Then wait for 2 seconds and adds question you want to add to your tumblr account.

```G1ANT
tumblr.open browse chrome
tumblr.login loginid <Enter your loginid here> password <Enter your password here>
delay 2
tumblr.tab tab <Enter tab you want to navigate,here>
```