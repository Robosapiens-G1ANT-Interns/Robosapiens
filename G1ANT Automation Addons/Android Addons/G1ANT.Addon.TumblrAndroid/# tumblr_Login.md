...
```G1ANT
tumblr.login loginid ⟦text⟧ password ⟦text⟧
```
...
This simple script opens chrome, searches for tumblr's webpage and login into your account by credentials that have been provided by you.
