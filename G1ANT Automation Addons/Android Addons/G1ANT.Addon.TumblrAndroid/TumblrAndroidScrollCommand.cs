...
{
    [Command(Name = "tumblrandroid.scroll", Tooltip = "This command is used to perform scroll action")]
    public class TumblrAndroidScrollCommand : Language.Command
    {
        public class Arguments : AppiumCommandArguments
        {
            [Argument(Tooltip = "Provide name of the capaility")]
            public new TextStructure Search { get; set; } = new TextStructure("");

            [Argument(Tooltip = "Specify by wich capability the element will be searched")]
            public new TextStructure By { get; set; } = new TextStructure("");
        ...
        public TumblrAndroidScrollCommand(AbstractScripter scripter) : base(scripter)
        {
