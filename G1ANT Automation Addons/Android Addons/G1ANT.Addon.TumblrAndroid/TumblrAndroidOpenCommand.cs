...
{
    [Command(Name = "tumblrandroid.open", Tooltip = "This command initialises appium server and opens tumblr app.")]
    public class TumblrAndroidOpenCommand : Language.Command
    {
        ...
        public TumblrAndroidOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
