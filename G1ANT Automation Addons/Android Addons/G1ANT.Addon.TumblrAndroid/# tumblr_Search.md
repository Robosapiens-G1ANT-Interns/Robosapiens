...
| -------- | ---- | -------- | ------------- | ----------- |
| `loginid` | [text] |yes  |    |Enter loginid of your tumblr account |
| `password` | [text] |yes   |    |Enter password of your tumblr account |
| `textsearch` | [text] |yes   |    |Enter keyword you want to search on your tumblr account |
...
This simple script opens chrome, searches for tumblr's webpage and login into your account by credentials that have been provided by you. Then wait for 2 seconds and adds keyword you want to search.

```G1ANT
tumblr.open browse chrome
tumblr.login loginid <Enter your loginid here> password <Enter your password here>
delay 2
tumblr.search textsearch <Enter keyword, you want to search here>
```
