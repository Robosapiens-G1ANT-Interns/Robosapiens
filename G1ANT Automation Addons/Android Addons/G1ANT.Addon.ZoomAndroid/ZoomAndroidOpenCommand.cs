...
{
    [Command(Name = "zoomandroid.open", Tooltip = "Opens zoom app instance on a connected android device.")]
    public class ZoomAndroidOpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("com.zipow.videobox.IMActivity");
        ...
        public ZoomAndroidOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
