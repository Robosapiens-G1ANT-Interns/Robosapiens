...
{
    [Command(Name = "naukriandroid.open", Tooltip = "Opens naukri app instance on a connected android device.")]
    public class NaukriAndroidOpenCommand : Language.Command
    {
        private static AndroidDriver<AndroidElement> driver;
        public class Arguments : CommandArguments
        {
            [Argument(DefaultVariable = "AppActivity", Tooltip = "AppActivity")]
            public TextStructure AppActivity { get; set; } = new TextStructure("com.naukri.dashboard.view.MNJDashboardActivity");
        ...
        public NaukriAndroidOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
