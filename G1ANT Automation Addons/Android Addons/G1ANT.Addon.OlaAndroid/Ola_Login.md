...
| -------- | ---- | -------- | ------------- | ----------- |
| `phone` | [text] |yes  |    |Enter phone number registered to your ola account |
...
This simple script opens chrome, searches for ola's webpage and login into your account by credentials that have been provided by you.

```G1ANT
ola.open browse chrome
ola.login loginid <Enter your phone here> 
```
