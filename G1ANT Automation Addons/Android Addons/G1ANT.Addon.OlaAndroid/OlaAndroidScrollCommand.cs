...
{
    [Command(Name = "olaandroid.scroll", Tooltip = "This command is used to perform scroll action")]
    public class OlaAndroidScrollCommand : Language.Command
    {
        ...
        public OlaAndroidScrollCommand(AbstractScripter scripter) : base(scripter)
        {
