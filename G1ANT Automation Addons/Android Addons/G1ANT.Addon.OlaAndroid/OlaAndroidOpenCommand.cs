...
{
    [Command(Name = "olaandroid.open", Tooltip = "This command initialises appium server and opens ola app.")]
    public class OlaAndroidOpenCommand : Language.Command
    {
        ...
        public class Arguments : AppiumCommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("yoda.rearch.core.NewMainActivity");
        ...
        public OlaAndroidOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
