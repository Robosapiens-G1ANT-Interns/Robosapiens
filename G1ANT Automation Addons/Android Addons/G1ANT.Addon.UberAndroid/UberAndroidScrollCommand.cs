...
{
    [Command(Name = "uberandroid.scroll", Tooltip = "This command is used to perform scroll action")]
    public class UberAndroidScrollCommand : Language.Command
    {
        ...
        public UberAndroidScrollCommand(AbstractScripter scripter) : base(scripter)
        {
