...
{
    [Command(Name = "uberandroid.open", Tooltip = "This command initialises appium server and opens Uber app.")]
    public class UberAndroidOpenCommand : Language.Command
    {
        ...
        public UberAndroidOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
