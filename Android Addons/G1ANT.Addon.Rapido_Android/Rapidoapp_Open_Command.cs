...
{
    [Command(Name = "rapidoapp.open", Tooltip = "This command is used to open the rapido from your device")]
    public class OpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("com.rapido.passenger.activities.SplashScreen");
