...
{
    [Command(Name = "telegramandroid.open", Tooltip = "Opens telegram app instance on a connected android device.")]
    public class TelegramAndroidOpenCommand : Language.Command
    {
        ...
        public TelegramAndroidOpenCommand(AbstractScripter scripter) :
            base(scripter)
        {
        }
