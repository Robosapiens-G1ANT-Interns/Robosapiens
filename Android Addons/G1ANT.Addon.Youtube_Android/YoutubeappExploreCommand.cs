...
{
    [Command(Name = "youtubeapp.explore", Tooltip = "This simple script opens an youtube application instance in the connected android device and navigates to the explore tab")]
