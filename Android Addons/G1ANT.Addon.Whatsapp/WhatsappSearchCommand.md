...
This command searches for a conversation in Whatsapp and then opens it.
...
This simple script opens a Whatsapp conversation in the connected android device:
