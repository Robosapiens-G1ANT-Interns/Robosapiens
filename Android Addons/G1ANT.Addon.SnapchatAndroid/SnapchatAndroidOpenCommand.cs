...
{
    [Command(Name = "snapchatandroid.open", Tooltip = "This command initialises appium server and opens snapchat application.")]
    public class SnapchatAndroidOpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("LandingPageActivity");
        ...
        public SnapchatAndroidOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
