...
{
    [Command(Name = "linkedin.open", Tooltip = "This command opens linked in a web browser provided in the Argument.")]
    public class myCommand : Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure Url { get; set; } = new TextStructure("www.linkedin.com");
