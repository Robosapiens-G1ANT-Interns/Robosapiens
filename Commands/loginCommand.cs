...
{
    [Command(Name = "linked.login", Tooltip = "This command opens LinkedIn in a web browser provided in the Argument.")]
    public class linkedloginCommand : Command
    {
        public linkedloginCommand(AbstractScripter scripter) : base(scripter)
        {
